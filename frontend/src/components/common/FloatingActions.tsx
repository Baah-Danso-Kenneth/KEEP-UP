    ...
    return (
        <div className="fixed bottom-8 right-8 z-[100] flex flex-col items-end gap-4">
            ...
            <AnimatePresence>
                {isScrollVisible && (
                    <motion.button
                        ...
                        whileTap={{ scale: 0.9 }}
                        className="bg-[var(--fg)]/10 backdrop-blur-md text-[var(--fg)] p-3 rounded-full shadow-2xl border border-[var(--fg)]/20 transition-colors hover:bg-[var(--fg)] hover:text-[var(--bg)]"
            ...
            <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="group relative flex items-center gap-3 bg-[var(--fg)]/80 backdrop-blur-xl px-6 py-3 rounded-full border border-[var(--bg)]/10 shadow-2xl overflow-hidden"
            >
                ...
                <div className="relative w-6 h-6 flex items-center justify-center">
                    <SolidLogo className="w-6 h-6 text-[var(--bg)]" />
                </div>

                {/* Text */}
                <span className="relative text-sm font-medium text-[var(--bg)] tracking-wide">
                    Ask AI
                </span>
