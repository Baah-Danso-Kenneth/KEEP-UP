...
export default function DebatePage() {
    ...
    return (
        <main className="min-h-screen bg-black text-white selection:bg-[var(--primaryColor)] selection:text-black">
            <div className="relative min-h-screen px-6 py-12 pb-40">
                <div className="max-w-7xl mx-auto space-y-16">
                    ...
                    <div className="border-t border-l border-white/10 rounded-tl-3xl rounded-tr-3xl overflow-hidden">
                    ...
                    {debateComplete && (
                        <div className="flex justify-center pt-12 pb-20">
                            <button
                                ...
                                className="bg-[var(--primaryColor)] text-black font-black text-xl px-10 py-5 rounded-full hover:scale-105 hover:shadow-[0_0_40px_rgba(201,252,110,0.6)] transition-all duration-300 flex items-center gap-3"
                            >
