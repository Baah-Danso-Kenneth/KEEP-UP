...
export default function PlanPage() {
    ...
    const { finalPlan, confidenceScore, isComplete } = useAppSelector(state => state.onboarding);
            ...
            <div ref={containerRef} className="max-w-7xl mx-auto px-6 py-24">
                ...
                <div className="flex flex-col items-center justify-center plan-cta">
                    <button
                        ...
                        className="group relative inline-flex items-center gap-3 px-12 py-6 bg-white text-black rounded-full text-xl font-bold tracking-wide hover:scale-105 transition-all duration-300"
                    >
