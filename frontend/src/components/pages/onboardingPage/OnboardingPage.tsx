    ...
    return (
        <main className="min-h-screen bg-black text-white selection:bg-[var(--primaryColor)] selection:text-black">
            <div className="relative min-h-screen flex items-center justify-center px-6 overflow-hidden">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[var(--primaryColor)] rounded-full blur-[150px] opacity-10 animate-pulse duration-[5000ms]" />

                <div className="relative w-full max-w-2xl">
                    <OnboardingHeader />
                    <ProgressIndicator currentStep={currentStep} />

                    <div ref={formRef} className="bg-white/5 backdrop-blur-xl border border-white/10 p-6 rounded-3xl shadow-2xl">
                        {error && (
